...
Для этого необходимо в папке проекта QuartusPrime **simulation/ModelSim** создать файл, например, с именем Sequence.txt. В testbench сначала:

    - объявить указатель дескриптора файла;
