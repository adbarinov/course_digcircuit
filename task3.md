...
3. *На 5 баллов*. На основе генератора ПСП из п. 1 (в качестстве второго и третьего генераторов возьмите циклически предыдущий и следующий генератор из списка, либо измените начальное состояние регистра из п. 1) соберите управляемый генератор и проведите анализ его работы по аналогии с п. 2:
